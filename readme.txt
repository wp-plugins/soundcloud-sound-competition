=== SoundCloud Sound Competition plugin for Wordpress ===
Contributors: canitb
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=U7ZQC4QH7MVP2
Tags: soundcloud, remix competition, remix comp, host remix competition, soundcloud remix comeptition, soundcloud integration
...
Host your own remix competition all within your wordpress site all integrated with SoundCloud!
...
You can chose the database slug when a competition has come to an end and you want to start another one, this creates a new competition.
