...
function get_remixcomp_admin_header() {
     $return_string =   '<h1 style="margin-bottom:5px;">SoundCloud Sound Contest</h1>'.
                        ...
                        '<p class="description" style="margin-top:0px;">Made by Kenneth Berentzen, more info about this plugin -> <a href="http://webhjelpen.no/wordpress-plugins/" target="new">Webhjelpen.no</a></p>'.
